...
bot_data = {
:presubs => [
["dont", "don't"], ["youre", "you're"], ["love", "like"],
["apologize", "are sorry"], ["dislike", "hate"], ["despise", "hate"],
["yeah", "yes"], ["mom", "family"]
],
:responses => {
  :default => ["I don't understand.", "What?", "Huh?",
  "Tell me abouot something else.",
  "I'm tired of this. Change the subject, please."],

  :greeting => ["Hi. I'm [name]. Want to chat?", "What's on your mind today?",
