...
class TestWordPlay < Minitest::Test
  #Test that multiple sentence blocks are spllit up into individual
  #words correctly
  def test_sentences
    ...
    assert_equal(["What", "Why", "I think it's finished here", "", "", "what do you think"],
      "What! Why? I think it's finished here...what do you think?..".sentences)
  end
  ...
  #Test for fail complex pronouns that do not follow wordplay rule for "i"
