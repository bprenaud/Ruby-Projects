...
class BotServlet < WEBrick::HTTPServlet::AbstractServlet
  #A basic HTML template consisting of a basic page with a perform
  # and text entry box for the user to converse with our bot. It uses some
  # placeholder text (%RESPONSE%) so the bot's responses can be substituted
  # in easily later.
  @@html = %q{
  <html><body>
  <form method="get">
...
$bot = Bot.new(name: "Eddy", data_file: "eddy.bot")
